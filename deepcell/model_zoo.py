...
def dilated_bn_feature_net_31x31_3D(input_shape=(1, 1080, 1280, 2), n_features=3, n_channels=1, reg=1e-5, init='he_normal', weights_path=None, norm_method='whole_image'):
    print('Using dilated feature net 31x31 with batch normalization')
