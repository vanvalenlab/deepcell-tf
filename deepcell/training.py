...
from .image_generators import SampleMovieDataGenerator
...
def train_model_sample(model=None, dataset=None, optimizer=None, max_samples=None,
    ...
    loss_history = model.fit_generator(
        datagen.flow(train_dict, batch_size=batch_size, max_samples=max_samples),
        steps_per_epoch=train_dict['y'].shape[0] // batch_size,
        epochs=n_epoch,
        validation_data=datagen_val.flow(test_dict, batch_size=batch_size, max_samples=max_samples),
...
def train_model_watershed(model=None, dataset=None, optimizer=None,
    ...
    loss_history = model.fit_generator(
        ...
        epochs=n_epoch,
        class_weight=class_weight,
        validation_data=datagen_val.flow(test_dict, batch_size=batch_size, distance_bins=distance_bins),
...
def train_model_movie(model=None, dataset=None, optimizer=None,
    ...
    loss_history = model.fit_generator(
        ...
        validation_data=datagen_val.flow(test_dict, batch_size=batch_size, frames_per_batch=frames_per_batch),
...
def train_model_sample_movie(model=None, dataset=None, optimizer=None, max_samples=None,
                             expt='', it=0, batch_size=32, n_epoch=100,
                             direc_save='/data/models', direc_data='/data/npz_data',
                             lr_sched=rate_scheduler(lr=0.01, decay=0.95),
                             rotation_range=0, flip=True, shear=0, class_weight=None):
...
def train_model_watershed_3D(model=None, dataset=None, optimizer=None,
    ...
    # fit the model on the batches generated by datagen.flow()
    loss_history = model.fit_generator(
        datagen.flow(train_dict, batch_size=batch_size, distance_bins=distance_bins, frames_per_batch=frames_per_batch, erosion_width=erosion_width),
        steps_per_epoch=(train_dict['y'].shape[0] * train_dict['y'].shape[time_axis] // frames_per_batch) // batch_size,
        epochs=n_epoch,
        class_weight=class_weight,
        validation_data=datagen_val.flow(test_dict, batch_size=batch_size, distance_bins=distance_bins, frames_per_batch=frames_per_batch, erosion_width=erosion_width),
        validation_steps=(test_dict['X'].shape[0] * test_dict['X'].shape[time_axis] // frames_per_batch) // batch_size,
        callbacks=[
            ModelCheckpoint(file_name_save, monitor='val_loss', verbose=1, save_best_only=True, mode='auto'),
            LearningRateScheduler(lr_sched)
